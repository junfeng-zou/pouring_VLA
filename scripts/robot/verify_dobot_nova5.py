...
Usage:
    /home/zjf/IsaacLab/isaaclab.sh -p scripts/robot/verify_dobot_nova5.py

    # Headless mode (no GUI, prints joint info only):
    /home/zjf/IsaacLab/isaaclab.sh -p scripts/robot/verify_dobot_nova5.py --headless

    # Num environments (default: 1):
    /home/zjf/IsaacLab/isaaclab.sh -p scripts/robot/verify_dobot_nova5.py --num_envs 2
"""
